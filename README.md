...
This means that 1000L of water consumes 10.6kg of CO2, therefore an average shower consumes $\frac{50}{1000} \times 10600 = 530g$ of CO2 and a bath $\frac{150}{1000} \times 10600 = 1590g$. Therefore the amount of CO2 saved between a shower and a bath is the difference $1590 - 530 = 1060g$ that we rounded to 1.1kg for simplicity.
